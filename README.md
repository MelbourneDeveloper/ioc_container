...
Check out the [benchmarks folder](https://github.com/MelbourneDeveloper/ioc_container/tree/main/benchmarks) of the GitHub repository to check out the benchmarks. 
